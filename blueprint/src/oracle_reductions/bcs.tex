...
Partly formalized. \texttt{ArkLib/OracleReduction/BCS/Basic.lean} now carries the
batched protocol specification (\texttt{ProtocolSpec.BCSTransform}) and the
admissibility obligation of Remark~\ref{rem:bcs_shortness}
(\texttt{BCS.BatchingAdmissibility}). The reduction-level transform and the security
statements of Section~\ref{sec:bcs_security} are still to be written.
